...
public class OneShopPanel extends JPanel {
	...
	public OneShopPanel(String name, final double price,
		...
		amount.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				priceLabel.setText((PropertiesManager
						.getProperties(PropertiesManager.OSP_TOTAL_LABEL))
						+ totalPrice
						+ (PropertiesManager
		...
		JLabel deleteLabel = new JLabel(new ImageIcon(
				PropertiesManager
						.getProperties(PropertiesManager.OSP_DELETE_IMG_PATH)));
	 ...
	 * gets the name param
	 * 
	 * @return the name of the coctail
	 */
	 ...
	 * 
	 * @return total price (amoun*price)
	 */
