...
//        Properties props = new Properties();
//        props.put(MAIL_HOST, "smtp.gmail.com"); // for gmail use smtp.gmail.com
//        props.put(MAIL_AUTH, TRUE);
//        props.put(MAIL_DEBUG, TRUE); 
//        props.put(MAIL_ENABLE, TRUE);
//        props.put(MAIL_PORT, PORT_NUM);
...
//        props.put(MAIL_FALLBACK, FALSE);
        ...
        Session mailSession = Session.getInstance(SendMail.getProperties(), new javax.mail.Authenticator() {
