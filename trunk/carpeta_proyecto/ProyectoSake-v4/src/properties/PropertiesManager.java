...
public class PropertiesManager {
	...
	// SearchResultPage keys
	public static final String SRP_NO_RESULT_FOUND_LABEL = "srp_no_result_found_label";
	...
	// FaqFrame
	public static final String FF_TITLE_FRAME = "ff_title_frame";
	public static final String FF_USER_MANUAL_LABEL = "ff_user_manual_label";
	public static final String FF_FAQ_HEAD_LABEL ="ff_faq_head_label";
